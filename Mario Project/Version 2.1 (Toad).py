...
carimg = pygame.image.load(os.path.join(APP_FOLDER, 'Toad\Toad_straight.png'))
carrightimg = pygame.image.load(os.path.join(APP_FOLDER, 'Toad\Toad_right_turn.png'))
carleftimg = pygame.image.load(os.path.join(APP_FOLDER, 'Toad\Toad_left_turn.png'))
