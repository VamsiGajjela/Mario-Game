...
carimg = pygame.image.load('Toad\Toad_straight.png')
carrightimg = pygame.image.load('Toad\Toad_right_turn.png')
carleftimg = pygame.image.load('Toad\Toad_left_turn.png')
