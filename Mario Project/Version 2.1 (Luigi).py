...
carimg = pygame.image.load(os.path.join(APP_FOLDER, 'Luigi\luigi_straight.png'))
carrightimg = pygame.image.load(os.path.join(APP_FOLDER, 'Luigi\luigi_right_turn.png'))
carleftimg = pygame.image.load(os.path.join(APP_FOLDER, 'Luigi\luigi_left_turn.png'))
